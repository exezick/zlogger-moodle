 ...
 * @copyright  2020 Kuiamenh martin
...
if ($hassiteconfig) {
    ...
    $settings->add(new admin_setting_configcheckbox('logstore_zlogger/logguests',
    ...
    $settings->add(new admin_setting_configselect('logstore_zlogger/loglifetime',
